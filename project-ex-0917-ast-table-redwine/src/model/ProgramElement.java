...
public class ProgramElement {
	...
	public Integer getStartingPositionOfMethod() {
		return startingPositionOfMethod;
	}

	public void setStartingPositionOfMethod(Integer startingPositionOfMethod) {
		this.startingPositionOfMethod = startingPositionOfMethod;
	}
