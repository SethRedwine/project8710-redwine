...
public class MyTableViewer {
	public final static String ID = "project-ex-0924-table-redwine.partdescriptor.simpletableaddingdeletingredwine";
	public final static String POPUPMENU = "project-ex-0924-table-redwine.popupmenu.mypopupmenu";
	...
	public void createControls(Composite parent, EMenuService menuService) {
		...
		Boolean reg = menuService.registerContextMenu(viewer.getControl(), POPUPMENU);
		System.out.println("Registered Menu: " + reg.toString());
