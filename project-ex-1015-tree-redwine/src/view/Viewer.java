...
import model.provider.LabelProviderMethodLocation;
...
public class Viewer {
	public static final String ID = "project-ex-1015-tree-redwine.partdescriptor.simpleasttreerenameredwine";
	...
	private void createProgElemColumns() {
		...
		col.setLabelProvider(new DelegatingStyledCellLabelProvider(new LabelProviderMethodLocation()));
	}
